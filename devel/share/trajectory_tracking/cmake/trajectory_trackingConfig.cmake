...
if("TRUE" STREQUAL "TRUE")
  set(trajectory_tracking_SOURCE_PREFIX /home/prajval/arduino_ws/src/trajectory_tracking)
  set(trajectory_tracking_DEVEL_PREFIX /home/prajval/arduino_ws/devel)
  ...
  set(trajectory_tracking_INSTALL_PREFIX /home/prajval/arduino_ws/install)
...
if(NOT " " STREQUAL " ")
  ...
  elseif(NOT " " STREQUAL " ")
    ...
    set(_report "Report the problem to the maintainer 'damani alla eddine <damani.alaaeddine@gmail.com>' and request to fix the problem.")
  endif()
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'trajectory_tracking' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/prajval/arduino_ws/src/trajectory_tracking/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(${library} MATCHES "^-")
    ...
    if(NOT trajectory_tracking_NUM_DUMMY_TARGETS)
      set(trajectory_tracking_NUM_DUMMY_TARGETS 0)
    endif()
    # Make sure the target name is unique
    set(interface_target_name "catkin::trajectory_tracking::wrapped-linker-option${trajectory_tracking_NUM_DUMMY_TARGETS}")
    while(TARGET "${interface_target_name}")
      math(EXPR trajectory_tracking_NUM_DUMMY_TARGETS "${trajectory_tracking_NUM_DUMMY_TARGETS}+1")
      set(interface_target_name "catkin::trajectory_tracking::wrapped-linker-option${trajectory_tracking_NUM_DUMMY_TARGETS}")
    endwhile()
    ...
    list(APPEND trajectory_tracking_LIBRARIES "${interface_target_name}")
...
set(trajectory_tracking_EXPORTED_TARGETS "")
...
set(depends "gazebo_ros;geometry_msgs;nav_msgs;roscpp;rospy;std_msgs;tf")
