...
if(wheelchair_pkg_CONFIG_INCLUDED)
  return()
endif()
set(wheelchair_pkg_CONFIG_INCLUDED TRUE)

# set variables for source/devel/install prefixes
if("TRUE" STREQUAL "TRUE")
  set(wheelchair_pkg_SOURCE_PREFIX /home/prajval/arduino_ws/src/wheelchair_pkg)
  set(wheelchair_pkg_DEVEL_PREFIX /home/prajval/arduino_ws/devel)
  set(wheelchair_pkg_INSTALL_PREFIX "")
  set(wheelchair_pkg_PREFIX ${wheelchair_pkg_DEVEL_PREFIX})
else()
  set(wheelchair_pkg_SOURCE_PREFIX "")
  set(wheelchair_pkg_DEVEL_PREFIX "")
  set(wheelchair_pkg_INSTALL_PREFIX /home/prajval/arduino_ws/install)
  set(wheelchair_pkg_PREFIX ${wheelchair_pkg_INSTALL_PREFIX})
endif()

# warn when using a deprecated package
if(NOT "" STREQUAL "")
  set(_msg "WARNING: package 'wheelchair_pkg' is deprecated")
...
set(wheelchair_pkg_FOUND_CATKIN_PROJECT TRUE)

if(NOT " " STREQUAL " ")
  set(wheelchair_pkg_INCLUDE_DIRS "")
  set(_include_dirs "")
  if(NOT " " STREQUAL " ")
  ...
  elseif(NOT " " STREQUAL " ")
    ...
    set(_report "Report the problem to the maintainer 'prajval <prajval@todo.todo>' and request to fix the problem.")
  endif()
  foreach(idir ${_include_dirs})
    if(IS_ABSOLUTE ${idir} AND IS_DIRECTORY ${idir})
      set(include ${idir})
    elseif("${idir} " STREQUAL "include ")
      get_filename_component(include "${wheelchair_pkg_DIR}/../../../include" ABSOLUTE)
      if(NOT IS_DIRECTORY ${include})
        message(FATAL_ERROR "Project 'wheelchair_pkg' specifies '${idir}' as an include dir, which is not found.  It does not exist in '${include}'.  ${_report}")
      endif()
    else()
      message(FATAL_ERROR "Project 'wheelchair_pkg' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/prajval/arduino_ws/src/wheelchair_pkg/${idir}'.  ${_report}")
    endif()
    _list_append_unique(wheelchair_pkg_INCLUDE_DIRS ${include})
  endforeach()
endif()
...
foreach(library ${libraries})
  ...
  if("${library}" MATCHES "^(debug|optimized|general)$")
    list(APPEND wheelchair_pkg_LIBRARIES ${library})
  elseif(${library} MATCHES "^-l")
    list(APPEND wheelchair_pkg_LIBRARIES ${library})
  elseif(${library} MATCHES "^-")
    # This is a linker flag/option (like -pthread)
    # There's no standard variable for these, so create an interface library to hold it
    if(NOT wheelchair_pkg_NUM_DUMMY_TARGETS)
      set(wheelchair_pkg_NUM_DUMMY_TARGETS 0)
    endif()
    # Make sure the target name is unique
    set(interface_target_name "catkin::wheelchair_pkg::wrapped-linker-option${wheelchair_pkg_NUM_DUMMY_TARGETS}")
    while(TARGET "${interface_target_name}")
      math(EXPR wheelchair_pkg_NUM_DUMMY_TARGETS "${wheelchair_pkg_NUM_DUMMY_TARGETS}+1")
      set(interface_target_name "catkin::wheelchair_pkg::wrapped-linker-option${wheelchair_pkg_NUM_DUMMY_TARGETS}")
    endwhile()
    ...
    list(APPEND wheelchair_pkg_LIBRARIES "${interface_target_name}")
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    endforeach()
    if(lib)
      _list_append_unique(wheelchair_pkg_LIBRARY_DIRS ${lib_path})
      list(APPEND wheelchair_pkg_LIBRARIES ${lib})
    else()
      # as a fall back for non-catkin libraries try to search globally
      find_library(lib ${library})
      if(NOT lib)
        message(FATAL_ERROR "Project '${PROJECT_NAME}' tried to find library '${library}'.  The library is neither a target nor built/installed properly.  Did you compile project 'wheelchair_pkg'?  Did you find_package() it before the subdirectory containing its code is included?")
      endif()
      list(APPEND wheelchair_pkg_LIBRARIES ${lib})
    endif()
  endif()
...
set(wheelchair_pkg_EXPORTED_TARGETS "")
# create dummy targets for exported code generation targets to make life of users easier
foreach(t ${wheelchair_pkg_EXPORTED_TARGETS})
  if(NOT TARGET ${t})
    add_custom_target(${t})
  endif()
endforeach()
...
foreach(depend ${depends})
  ...
  list(GET depend_list 0 wheelchair_pkg_dep)
  list(LENGTH depend_list count)
  if(${count} EQUAL 1)
    # simple dependencies must only be find_package()-ed once
    if(NOT ${wheelchair_pkg_dep}_FOUND)
      find_package(${wheelchair_pkg_dep} REQUIRED NO_MODULE)
    endif()
  else()
    # dependencies with components must be find_package()-ed again
    list(REMOVE_AT depend_list 0)
    find_package(${wheelchair_pkg_dep} REQUIRED NO_MODULE ${depend_list})
  endif()
  _list_append_unique(wheelchair_pkg_INCLUDE_DIRS ${${wheelchair_pkg_dep}_INCLUDE_DIRS})

  # merge build configuration keywords with library names to correctly deduplicate
  _pack_libraries_with_build_configuration(wheelchair_pkg_LIBRARIES ${wheelchair_pkg_LIBRARIES})
  _pack_libraries_with_build_configuration(_libraries ${${wheelchair_pkg_dep}_LIBRARIES})
  _list_append_deduplicate(wheelchair_pkg_LIBRARIES ${_libraries})
  # undo build configuration keyword merging after deduplication
  _unpack_libraries_with_build_configuration(wheelchair_pkg_LIBRARIES ${wheelchair_pkg_LIBRARIES})

  _list_append_unique(wheelchair_pkg_LIBRARY_DIRS ${${wheelchair_pkg_dep}_LIBRARY_DIRS})
  list(APPEND wheelchair_pkg_EXPORTED_TARGETS ${${wheelchair_pkg_dep}_EXPORTED_TARGETS})
endforeach()

set(pkg_cfg_extras "")
foreach(extra ${pkg_cfg_extras})
  if(NOT IS_ABSOLUTE ${extra})
    set(extra ${wheelchair_pkg_DIR}/${extra})
  endif()
  include(${extra})
endforeach()
